...
/**
 * An implementation of [Lazy] for creating an instance of the [MaterialPowerMenu] lazily in Activities.
 * Tied to the given [lifecycleOwner], [clazz].
 *
 * @param context A context for creating resources of the [MaterialPowerMenu] lazily.
 ...
 */
@PublishedApi
internal class ActivityMaterialPowerMenuLazy<out T : MaterialPowerMenu.Factory>(
