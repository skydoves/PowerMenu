...
/**
 * MaterialPowerMenu is one the implementation of the {@link AbstractPowerMenu}.
 *
 ...
 */
public class MaterialPowerMenu
    extends AbstractPowerMenu<
        PowerMenuItem, MenuListAdapter, LayoutMaterialPowerMenuLibrarySkydovesBinding>
    implements IPowerMenuAdapter {

  protected MaterialPowerMenu(
  ...
  protected void initialize(@NonNull Context context) {
    ...
    binding = LayoutMaterialPowerMenuLibrarySkydovesBinding.inflate(layoutInflater, null, false);
    super.initialize(context);
    this.adapter = new MenuListAdapter(menuListView);
  }

  @Override
  View getMenuRoot(LayoutMaterialPowerMenuLibrarySkydovesBinding binding) {
    return binding.getRoot();
  }

  @Override
  ListView getMenuList(LayoutMaterialPowerMenuLibrarySkydovesBinding binding) {
    return binding.powerMenuListView;
  }

  @Override
  CardView getMenuCard(LayoutMaterialPowerMenuLibrarySkydovesBinding binding) {
  ...
  /** Builder class for creating {@link MaterialPowerMenu}. */
  ...
  public static class Builder extends AbstractMenuBuilder {
    ...
    public MaterialPowerMenu build() {
      return new MaterialPowerMenu(context, this);
    }
  }

  /**
   * An abstract factory class for creating an instance of {@link MaterialPowerMenu}.
   *
   * <p>A factory implementation class must have a non-argument constructor.
   */
  public abstract static class Factory {

    /** returns an instance of {@link MaterialPowerMenu}. */
    public abstract @NonNull MaterialPowerMenu create(
